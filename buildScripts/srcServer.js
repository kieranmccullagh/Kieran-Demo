...
var open = require('open'); //Reference to Open site in browser

var port = 4000; //Stores the port we will use
var app = express(); //Create an instance of express and set to the variable app

app.get('/', function(req, res) { //Tell express which routes to handle. Any references to route should handle this function
